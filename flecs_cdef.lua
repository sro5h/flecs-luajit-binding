...
typedef char* (*ecs_os_api_strdup_t)(char const*);
typedef void* (*ecs_os_thread_callback_t)(void*);
typedef ecs_os_thread_t (*ecs_os_api_thread_new_t)(ecs_os_thread_callback_t, void*);
typedef void* (*ecs_os_api_thread_join_t)(ecs_os_thread_t);
...
typedef void (*ecs_os_api_mutex_lock_t)(ecs_os_mutex_t);
typedef void (*ecs_os_api_mutex_unlock_t)(ecs_os_mutex_t);
typedef void (*ecs_os_api_mutex_free_t)(ecs_os_mutex_t);
typedef ecs_os_cond_t (*ecs_os_api_cond_new_t)(void);
typedef void (*ecs_os_api_cond_free_t)(ecs_os_cond_t);
typedef void (*ecs_os_api_cond_signal_t)(ecs_os_cond_t);
typedef void (*ecs_os_api_cond_broadcast_t)(ecs_os_cond_t);
typedef void (*ecs_os_api_cond_wait_t)(ecs_os_cond_t, ecs_os_mutex_t);
typedef void (*ecs_os_api_sleep_t)(int32_t, int32_t);
typedef void (*ecs_os_api_enable_high_timer_resolution_t)(bool);
typedef void (*ecs_os_api_get_time_t)(ecs_time_t*);
typedef uint64_t (*ecs_os_api_now_t)(void);
typedef void (*ecs_os_api_log_t)(int32_t, char const*, int32_t, char const*);
typedef void (*ecs_os_api_abort_t)(void);
typedef ecs_os_dl_t (*ecs_os_api_dlopen_t)(char const*);
typedef ecs_os_proc_t (*ecs_os_api_dlproc_t)(ecs_os_dl_t, char const*);
typedef void (*ecs_os_api_dlclose_t)(ecs_os_dl_t);
typedef char* (*ecs_os_api_module_to_path_t)(char const*);
